...
public class Vector4f {
    ...
    public boolean equals(Object object) {
        ...
        if (Float.compare(vector4f.x, this.x) != 0) return false;
        if (Float.compare(vector4f.y, this.y) != 0) return false;
        if (Float.compare(vector4f.z, this.z) != 0) return false;
    ...
    public void transform(Quaternion quaternion) {
        ...
        quaternion2.multiply(new Quaternion(x(), y(), z(), 0.0F));
        Quaternion quaternion3 = new Quaternion(quaternion);
        quaternion3.conjugate();
        quaternion2.multiply(quaternion3);
        set(quaternion2.getX(), quaternion2.getY(), quaternion2.getZ(), w());
    }
