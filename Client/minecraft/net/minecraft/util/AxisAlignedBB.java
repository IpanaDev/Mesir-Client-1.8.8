...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB addMax(double x, double y, double z)
    {
        double d0 = this.minX;
        double d1 = this.minY+y;
        double d2 = this.minZ;
    ...
    public boolean intersectsWithEquality(AxisAlignedBB other) {
        return other.maxX >= this.minX && other.minX <= this.maxX && (other.maxY >= this.minY && other.minY <= this.maxY && other.maxZ >= this.minZ && other.minZ <= this.maxZ);
    }
    /**
    ...
    public boolean isEqual(AxisAlignedBB other) {
    ...
    public Vec3 getPosition() {
        return new Vec3((this.minX + this.maxX) / 2, this.minY, (this.minZ + this.maxZ) / 2);
    }

    public boolean isPosEqual(AxisAlignedBB other) {
        double otherX = (other.minX+other.maxX)/2;
        double otherZ = (other.minZ+other.maxZ)/2;
        double thisX = (this.minX+this.maxX)/2;
        double thisZ = (this.minZ+this.maxZ)/2;

        return thisX == otherX && this.minY == other.minY && thisZ == otherZ;
    }

    public void offsetAndUpdate(double par1, double par3, double par5)
    {
        this.minX += par1;
        this.minY += par3;
        this.minZ += par5;
