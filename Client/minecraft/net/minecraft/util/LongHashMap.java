...
public class LongHashMap
{
    ...
    public LongHashMap(LongHashMap copy)
    {
        this.numHashElements = copy.numHashElements;
        this.hashArray = copy.hashArray;
        this.capacity = copy.capacity;
        this.mask = copy.mask;

        System.arraycopy(copy.hashArray, 0, hashArray, 0, copy.hashArray.length);
    }
