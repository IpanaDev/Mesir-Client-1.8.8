...
public class BlockPos extends Vec3i
{
    ...
    {
        final MutableBlockPos blockpos = new MutableBlockPos(Math.min(from.getX(), to.getX()), Math.min(from.getY(), to.getY()), Math.min(from.getZ(), to.getZ()));
        final MutableBlockPos blockpos1 = new MutableBlockPos(Math.max(from.getX(), to.getX()), Math.max(from.getY(), to.getY()), Math.max(from.getZ(), to.getZ()));
    ...
    public static final class MutableBlockPos extends BlockPos
    {
        ...
        public BlockPos.MutableBlockPos setPos(BlockPos pos) {
            return func_181079_c(pos.getX(), pos.getY(), pos.getZ());
        }
        ...
        {
            return this.func_181079_c(this.x + facing.getFrontOffsetX() * p_189534_2_, this.y + facing.getFrontOffsetY() * p_189534_2_, this.z + facing.getFrontOffsetZ() * p_189534_2_);
        }
    }
}
