...
public class RealmsBufferBuilder
{
    ...
    {
        this.b.setTranslation((float)p_offset_1_, (float)p_offset_3_, (float) p_offset_5_);
    }
    ...
    {
        this.b.putPosition((float)p_postProcessFacePosition_1_, (float)p_postProcessFacePosition_3_, (float)p_postProcessFacePosition_5_);
    }
