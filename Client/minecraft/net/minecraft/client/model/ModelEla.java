...
public class ModelEla {
    public static int textureWidth = 128;
    public static int textureHeight = 128;

    public void init(ModelElaBase player) {
        player.bipedLeftArm.mirror = false;
        player.bipedLeftArm = new ModelRenderer(player);
        player.bipedLeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
        player.bipedLeftArm.cubeList.add(new ModelBox(player.bipedLeftArm, 32, 48, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));
        player.bipedLeftArm.mirror = false;
        ModelRenderer bipedHeadHat = new ModelRenderer(player);
        bipedHeadHat.setRotationPoint(0.0F, 24.0F, 0.0F);
        player.bipedHead.addChild(bipedHeadHat);
        ...
        ModelRenderer bipedHeadHatMic = new ModelRenderer(player);
        ...
        ModelRenderer bipedBodyHarness = new ModelRenderer(player);
        bipedBodyHarness.setRotationPoint(0.0F, 24.0F, 0.0F);
        player.bipedBody.addChild(bipedBodyHarness);
        ...
        ModelRenderer bipedBodyBelt = new ModelRenderer(player);
        ...
        ModelRenderer bipedBodyHarnessTits = new ModelRenderer(player);
        ...
        ModelRenderer bipedRightArmSleeve = new ModelRenderer(player);
        bipedRightArmSleeve.setRotationPoint(5.0F, 22.0F, 0.0F);
        player.bipedRightArm.addChild(bipedRightArmSleeve);
        ...
        ModelRenderer bipedLeftArmSleeve = new ModelRenderer(player);
        bipedLeftArmSleeve.setRotationPoint(-5.0F, 22.0F, 0.0F);
        player.bipedLeftArm.addChild(bipedLeftArmSleeve);
        ...
        ModelRenderer bipedRightLegHolster = new ModelRenderer(player);
        bipedRightLegHolster.setRotationPoint(1.9F, 12.0F, 0.0F);
        player.bipedRightLeg.addChild(bipedRightLegHolster);
        ...
        ModelRenderer bipedLeftLegHolder = new ModelRenderer(player);
        bipedLeftLegHolder.setRotationPoint(-1.9F, 12.0F, 0.0F);
        player.bipedLeftLeg.addChild(bipedLeftLegHolder);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, ModelPlayer player) {
        player.bipedHead.showModel = true;
        player.bipedLeftLeg.showModel = true;
        player.bipedRightLeg.showModel = true;
    }
