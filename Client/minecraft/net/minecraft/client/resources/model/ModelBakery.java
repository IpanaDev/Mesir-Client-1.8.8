...
public class ModelBakery
{
    ...
    {
        Benchmark.benchmark("ModelManager (VariantItemModels)", () -> this.loadVariantItemModels());
        Benchmark.benchmark("ModelManager (ModelsCheck)", () -> this.loadModelsCheck());
        Benchmark.benchmark("ModelManager (Sprites)", () -> this.loadSprites());
        Benchmark.benchmark("ModelManager (BakeItem)", () -> this.bakeItemModels());
        Benchmark.benchmark("ModelManager (BakeBlock)", () -> this.bakeBlockModels());
    ...
    public List<String> getVariantNames(Item p_177596_1_) {
