...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    public IResource getResourceOrPut(ResourceLocation location) throws IOException {
        IResourceManager iresourcemanager = (IResourceManager)this.domainResourceManagers.get(location.getResourceDomain());
        if (iresourcemanager == null) {
            iresourcemanager = this.domainResourceManagers.put(location.getResourceDomain(), new FallbackResourceManager(rmMetadataSerializer));
        }
        if (iresourcemanager != null)
        {
            return iresourcemanager.getResourceOrPut(location);
        }
        else
        {
            throw new FileNotFoundException(location.toString());
