...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public void renderBlockDamage(IBlockState state, BlockPos pos, TextureAtlasSprite texture, IBlockAccess blockAccess)
    {
        ...
        if (i == 3)
        {
            ...
            this.blockModelRenderer.renderModel(blockAccess, ibakedmodel1, state, pos, Tessellator.getInstance().getWorldRenderer(), 0, 0, 0);
        }
    }

    public boolean renderBlock(IBlockState state, BlockPos pos, IBlockAccess blockAccess, WorldRenderer worldRendererIn, int diffX, int diffY, int diffZ)
    {
        try
        {
            ...
            if (i == -1) {
                ...
                switch (i) {
                    ...
                    case 3 -> {
                        ...
                        boolean flag = this.blockModelRenderer.renderModel(blockAccess, ibakedmodel, state, pos, worldRendererIn, diffX, diffY, diffZ);
                        if (Config.isShaders()) {
                            SVertexBuilder.popEntity(worldRendererIn);
                        }
                        return flag;
