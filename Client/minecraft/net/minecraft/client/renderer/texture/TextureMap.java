...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public static ITextureObject locationBlocksTextureObject;
    private final List listAnimatedSprites;
    private final HashMap<String, TextureAtlasSprite> mapRegisteredSprites;
    ...
    public void loadTextureAtlas(IResourceManager resourceManager)
    {
        ...
        for (final Object textureatlassprite20 : this.mapRegisteredSprites.values())
        {
            ...
            catch (Throwable throwable1)
            {
                ...
                crashreportcategory.addCrashSectionCallable("Sprite name", (Callable) () -> textureatlassprite2.getIconName());
                crashreportcategory.addCrashSectionCallable("Sprite size", (Callable) () -> textureatlassprite2.getIconWidth() + " x " + textureatlassprite2.getIconHeight());
                crashreportcategory.addCrashSectionCallable("Sprite frames", (Callable) () -> textureatlassprite2.getFrameCount() + " frames");
