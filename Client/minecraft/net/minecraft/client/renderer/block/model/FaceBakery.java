...
public class FaceBakery
{
    ...
    private int[] makeQuadVertexData(BlockPartFace blockPartFace, TextureAtlasSprite sprite, EnumFacing facing, float[] posDiv16, ITransformation transformation, BlockPartRotation blockPartRotation, boolean shade)
    {
        int i = 28;
        ...
        for (int j = 0; j < 4; ++j) {
            this.fillVertexData(aint, j, facing, blockPartFace, posDiv16, sprite, transformation, blockPartRotation, shade);
        }
    ...
    private void fillVertexData(int[] array, int p_fillVertexData_2_, EnumFacing p_fillVertexData_3_, BlockPartFace p_fillVertexData_4_, float[] p_fillVertexData_5_, TextureAtlasSprite p_fillVertexData_6_, ITransformation p_fillVertexData_7_, BlockPartRotation p_fillVertexData_8_, boolean p_fillVertexData_10_)
    {
        ...
        this.storeVertexData(array, j, p_fillVertexData_2_, vector3f, i, p_fillVertexData_6_, p_fillVertexData_4_.blockFaceUV);
    }
