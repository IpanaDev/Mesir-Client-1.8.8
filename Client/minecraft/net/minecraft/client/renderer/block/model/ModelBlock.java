    ...
    public static void checkModelHierarchy(Map<ResourceLocation, ModelBlock> p_178312_0_)
    {
        for (ModelBlock modelblock : p_178312_0_.values())
        {
            try
            {
                ...
                if (modelblock1 != null && modelblock1.parent != null) {
                    for (ModelBlock modelblock2 = modelblock1.parent; modelblock1.parent != null && modelblock2.parent != null && modelblock2.parent.parent != null && modelblock1 != modelblock2; modelblock2 = modelblock2.parent.parent) {
