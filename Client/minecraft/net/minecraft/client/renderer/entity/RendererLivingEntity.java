...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            float f81 = entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks;
            float pitchHead = entity == Minecraft.getMinecraft().thePlayer ? f81 : f8;
            ...
            if (this.renderOutlines) {
                ...
                this.renderModel(entity, f6, f5, f7, f2, pitchHead);
                //if (flag1) {
                ...
                if (!(entity instanceof EntityPlayer) || !((EntityPlayer) entity).isSpectator()) {
                    this.renderLayers(entity, f6, f5, partialTicks, f7, f2, pitchHead);
                }
                if (flag) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures)
    {
        ...
        boolean flag1 = entitylivingbaseIn.hurtResistantTime > 0 || entitylivingbaseIn.deathTime > 0;
        ...
        else
        {
            ...
            if (flag1) {
                float alpha = (entitylivingbaseIn.prevHurtResistantTime + (entitylivingbaseIn.hurtResistantTime - entitylivingbaseIn.prevHurtResistantTime) * partialTicks) / 40f;
                if (entitylivingbaseIn.hurtResistantTime >= 15) {
                    alpha = 0.4f;
                }
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (entity instanceof EntityPlayer && Modules.NAME_TAGS.isEnabled()) {
            //new EventRenderName((EntityPlayer) entity).fire();
            return;
        }
        if (this.canRenderName(entity) && this.renderManager.livingPlayer != null) {
            ...
            if (d0 < (double) (f * f)) {
                ...
                if (entity.isSneaking()) {
                    ...
                    GlStateManager.enableTexture2D();
                    GlStateManager.depthMask(true);
                    fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2f, 0, 553648127);
                    GlStateManager.enableLighting();
    ...
    protected boolean canRenderName(T entity)
    {
        ...
        if (entity instanceof EntityPlayer && entityplayersp != null &&  entity != entityplayersp)
        {
            ...
            if (team != null)
            {
                ...
                return switch (RendererLivingEntity$1.field_178679_a[team$enumvisible.ordinal()]) {
                    case 1 -> true;
                    case 2 -> false;
                    case 3 -> team1 == null || team.isSameTeam(team1);
                    case 4 -> team1 == null || !team.isSameTeam(team1);
                    default -> true;
                };
            }
        }
