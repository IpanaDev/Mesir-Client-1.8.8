...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    private void renderLayer(EntityLivingBase entitylivingbaseIn, float p_177182_2_, float p_177182_3_, float p_177182_4_, float p_177182_5_, float p_177182_6_, float p_177182_7_, float p_177182_8_, int armorSlot)
    {
        ...
        {
            ModelBase modelbase = this.getModelBase(armorSlot);
            ...
            this.setShown((T) modelbase, armorSlot);
            ...
            {
                this.renderEnchant(entitylivingbaseIn, modelbase, p_177182_2_, p_177182_3_, p_177182_4_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
            }
        }
    }
    ...
    public ModelBase getModelBase(int armorSlot)
    {
        return this.isSlotForLeggings(armorSlot) ? this.field_177189_c : this.field_177186_d;
    }
    ...
    private void renderEnchant(EntityLivingBase entitylivingbaseIn, ModelBase modelbaseIn, float p_177183_3_, float p_177183_4_, float p_177183_5_, float p_177183_6_, float p_177183_7_, float p_177183_8_, float p_177183_9_)
    {
    ...
    protected abstract void setShown(T p_177179_1_, int p_177179_2_);
