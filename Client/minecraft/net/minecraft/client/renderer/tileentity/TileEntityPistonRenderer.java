    ...
    public void renderTileEntityAt(TileEntityPiston te, double x, double y, double z, float partialTicks, int destroyStage)
    {
        ...
        if (block.getMaterial() != Material.air && te.getProgress(partialTicks) < 1.0F)
        {
            ...
            if (block == Blocks.piston_head && te.getProgress(partialTicks) < 0.5F)
            {
                ...
                this.blockRenderer.getBlockModelRenderer().renderModel(world, this.blockRenderer.getModelFromBlockState(iblockstate, world, blockpos), iblockstate, blockpos, worldrenderer, true, 0, 0, 0);
            }
            else if (te.shouldPistonHeadBeRendered() && !te.isExtending())
            {
                ...
                this.blockRenderer.getBlockModelRenderer().renderModel(world, this.blockRenderer.getModelFromBlockState(iblockstate1, world, blockpos), iblockstate1, blockpos, worldrenderer, true, 0, 0, 0);
            ...
            {
                this.blockRenderer.getBlockModelRenderer().renderModel(world, this.blockRenderer.getModelFromBlockState(iblockstate, world, blockpos), iblockstate, blockpos, worldrenderer, false, 0, 0, 0);
            }
