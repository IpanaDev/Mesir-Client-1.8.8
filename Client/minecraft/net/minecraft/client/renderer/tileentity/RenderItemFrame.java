...
public class RenderItemFrame extends Render<EntityItemFrame> {
    ...
    public void doRender(EntityItemFrame entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (mc.thePlayer.getDistanceSqToEntity(entity) > 625) {
            return;
        }
        ...
        GlStateManager.translate(0, 0, 0.4375);
        GlStateManager.enableTexture2D();
        GlStateManager.enableBlend();
        GlStateManager.blendFunc(770,771);
        GlStateManager.color(1,1,1,1);
        ItemStack displayedItem = entity.getDisplayedItem();
        if (displayedItem != null && displayedItem.getItem() != null) {
            this.renderItem(entity, displayedItem);
        }
    ...
    private void renderItem(EntityItemFrame itemFrame, ItemStack displayedItem) {

        if (displayedItem != null) {
            EntityItem entityitem = new EntityItem(itemFrame.worldObj, 0.0D, 0.0D, 0.0D, displayedItem);
    ...
    protected void renderName(EntityItemFrame entity, double x, double y, double z, ItemStack displayedItem)
    {
        if (Minecraft.isGuiEnabled() && displayedItem != null && displayedItem.hasDisplayName() && this.renderManager.pointedEntity == entity)
        {
            float f = 1.6F;
            ...
            if (d0 < (double)(f2 * f2))
            {
                String s = displayedItem.getDisplayName();
