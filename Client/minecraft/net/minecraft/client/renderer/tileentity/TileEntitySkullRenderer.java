...
public class TileEntitySkullRenderer extends TileEntitySpecialRenderer<TileEntitySkull>
{
    ...
    public void renderSkull(float p_180543_1_, float p_180543_2_, float p_180543_3_, EnumFacing p_180543_4_, float p_180543_5_, int p_180543_6_, GameProfile p_180543_7_, int p_180543_8_)
    {
        ...
        {
            switch (p_180543_6_) {
                default -> this.bindTexture(SKELETON_TEXTURES);
                case 1 -> this.bindTexture(WITHER_SKELETON_TEXTURES);
                case 2 -> {
                ...
                case 4 -> this.bindTexture(CREEPER_TEXTURES);
            }
        }
        ...
        {
            switch (p_180543_4_) {
                case NORTH -> GlStateManager.translate(p_180543_1_ + 0.5F, p_180543_2_ + 0.25F, p_180543_3_ + 0.74F);
                case SOUTH -> {
