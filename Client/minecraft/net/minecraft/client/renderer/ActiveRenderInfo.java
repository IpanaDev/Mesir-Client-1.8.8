...
public class ActiveRenderInfo {
     ...
     */
    public static void updateRenderInfo(float yaw, float pitch, boolean p_74583_1_) {
        ...
        float someCalc = (float)(1 - i * 2);
        float yawCalc = yaw * radian;
        float pitchCalc = pitch * radian;
        float sinPitchCalc = MathHelper.sin(pitchCalc) * someCalc;
        rotationX = MathHelper.cos(yawCalc) * someCalc;
        rotationZ = MathHelper.sin(yawCalc) * someCalc;
        rotationYZ = -rotationZ * sinPitchCalc;
        rotationXY = rotationX * sinPitchCalc;
        rotationXZ = MathHelper.cos(pitchCalc);
    }
