...
public class GlStateManager
{
    ...
    private static GlStateManager.MatrixMode matrixState = new GlStateManager.MatrixMode();
    ...
    public static void resetTextureState() {
        textureState[activeTextureUnit].textureName = 0;
    }

    public static TextureState currentTextureState() {
        return textureState[activeTextureUnit];
    }
    ...
    public static void forceBindTexture(int texture) {
        textureState[activeTextureUnit].textureName = texture;
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, texture);
    }
    ...
    public static void setTextureState(int tex) {
        textureState[activeTextureUnit].textureName = tex;
    }
    ...
    {
        if (matrixState.matrixMode != mode) {
            matrixState.matrixMode = mode;
    ...
    public enum TexGen
    {
        ...
        R(),
        Q();
        public static final TexGen[] VALUES = values();
