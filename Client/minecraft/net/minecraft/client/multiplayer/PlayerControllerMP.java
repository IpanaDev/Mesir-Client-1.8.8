...
public class PlayerControllerMP
{
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            if (flag && block1.getPlayerRelativeBlockHardness(this.mc.thePlayer) >= 1.0F) {
                PlayerUtils.ncpListener().ignoredBlockChanges.push(loc);
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing)
    {
        ...
        boolean fastBreak = Modules.FAST_BREAK.isEnabled() && Modules.FAST_BREAK.fastInteract.getValue();
        if (!fastBreak && this.blockHitDelay > 0)
        {
            --this.blockHitDelay;
            return true;
        }
    ...
    {
        return Modules.TELEPORT.isEnabled() || Modules.AUTO_CLAIM.isEnabled() ? 100 :(this.currentGameType.isCreative() ? 5.0F : 4.5f);
    }
    ...
    public void syncCurrentPlayItem()
    {
        ...
        if (i != this.currentPlayerItem)
        {
            ...
            this.lastC09Time = System.currentTimeMillis();
        }
    }
    ...
    {
        if (this.currentGameType == WorldSettings.GameType.SPECTATOR || itemStackIn == null) {
            return false;
        } else {
            this.syncCurrentPlayItem();
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn)
    {
        ...
        //PlayerUtils.debug(windowId+" : "+slotId+ " : "+mouseButtonClicked +" : "+mode+" : "+itemstack);
