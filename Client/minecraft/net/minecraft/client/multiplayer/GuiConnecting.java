...
public class GuiConnecting extends GuiScreen
{
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    GuiConnecting.this.networkManager = NetworkManager.func_181124_a(inetaddress, port, GuiConnecting.this.mc.gameSettings.isNativeTransport());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.networkManager == null)
        {
            this.drawCenteredString(I18n.format("connect.connecting"), this.width / 2, this.height / 2 - 50, 16777215);
        }
        else
        {
            this.drawCenteredString(I18n.format("connect.authorizing"), this.width / 2, this.height / 2 - 50, 16777215);
        }
