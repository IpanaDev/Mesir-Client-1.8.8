...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.field_152324_f.getFormattedText(), this.width / 2, i - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);

        for (String s : this.field_152323_r)
        {
            this.drawCenteredString(s, this.width / 2, i, 10526880);
