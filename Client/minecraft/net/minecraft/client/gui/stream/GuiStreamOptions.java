...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontHelper.SIZE_18.drawCenteredString(this.field_152319_i, this.width / 2, 20, 16777215);
        FontHelper.SIZE_18.drawCenteredString(this.field_152313_r, this.width / 2, this.field_152314_s, 16777215);

        if (this.field_152315_t)
        {
            FontHelper.SIZE_18.drawCenteredString(EnumChatFormatting.RED + I18n.format("options.stream.changes"), this.width / 2, 20 + this.fontRendererObj.FONT_HEIGHT, 16777215);
        }
