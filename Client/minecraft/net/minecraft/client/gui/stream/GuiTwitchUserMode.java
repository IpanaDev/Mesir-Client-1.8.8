...
public class GuiTwitchUserMode extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.field_152338_i.getUnformattedText(), this.width / 2, 70, 16777215);
        int i = 80;

        for (IChatComponent ichatcomponent : this.field_152332_r)
        {
            this.drawString(ichatcomponent.getFormattedText(), this.field_152334_t, i, 16777215);
