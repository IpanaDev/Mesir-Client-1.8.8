...
import static net.minecraft.world.biome.Biomes.hell;
...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private String func_175330_b(int p_175330_1_, float p_175330_2_)
    {
        switch (p_175330_1_)
        {
            ...
            case 162:
                ...
                else if ((int)p_175330_2_ >= hell.biomeID)
                {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.field_175339_B != 0)
        {
            ...
            tessellator.draw();
            this.drawCenteredString(I18n.format("createWorld.customize.custom.confirmTitle"), this.width / 2, 105, 16777215);
            this.drawCenteredString(I18n.format("createWorld.customize.custom.confirm1"), this.width / 2, 125, 16777215);
            this.drawCenteredString(I18n.format("createWorld.customize.custom.confirm2"), this.width / 2, 135, 16777215);
