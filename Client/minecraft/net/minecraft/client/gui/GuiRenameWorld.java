...
public class GuiRenameWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(I18n.format("selectWorld.renameTitle"), this.width / 2, 20, 16777215);
        this.drawString(I18n.format("selectWorld.enterName"), this.width / 2 - 100, 47, 10526880);
