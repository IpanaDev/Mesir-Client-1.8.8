...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(int componentId, FontUtil fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
        this.fontUtil = fontrendererObj;
        this.xPosition = x;
        this.yPosition = y;
        this.width = par5Width;
        this.height = par6Height;
    ...
    public void writeText(String p_146191_1_,boolean allowCharacter)
    {
        String s = "";
        String s1 = allowCharacter ? ChatAllowedCharacters.filterAllowedCharacters(p_146191_1_) : p_146191_1_;
        int i = Math.min(this.cursorPosition, this.selectionEnd);
        int j = Math.max(this.cursorPosition, this.selectionEnd);
        int k = this.maxStringLength - this.text.length() - (i - j);
        int l = 0;
    ...
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_,boolean allowCharacter)
    {
        if (!this.isFocused)
        {
            return false;
        ...
        else if (GuiScreen.isKeyComboCtrlV(p_146201_2_))
        {
            if (this.isEnabled)
            {
                this.writeText(GuiScreen.getClipboardString(),allowCharacter);
            }
                ...
                default:
                    if (ChatAllowedCharacters.isAllowedCharacter(p_146201_1_))
                    {
                        if (this.isEnabled)
                        {
                            ...
                            this.writeText(Character.toString(p_146201_1_),allowCharacter);
                        }
    ...
    public void mouseClicked(int mouseX, int mouseY, int button)
    {
        ...
        if (this.isFocused && flag && button == 0)
        {
            ...
            } else if (fontUtil != null) {
                String s = this.fontUtil.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
                this.setCursorPosition(this.fontUtil.trimStringToWidth(s, i).length() + this.lineScrollOffset);
            }
        }
    }
    ...
    public void drawTextBox() {
        if (this.getVisible())
        {
            ...
            String s = "";
            if (fontRendererInstance != null) {
                s = fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            } else if (fontUtil != null) {
                s = fontUtil.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            }
            ...
            if (s.length() > 0)
            {
                ...
                if (fontRendererInstance != null) {
                    ...
                    fontUtil.drawStringWithShadow(s1, (float)l, (float)i1, i);
                }
            }
            ...
            if (s.length() > 0 && flag && j < s.length())
            {
                if (fontRendererInstance != null) {
                    ...
                    fontUtil.drawStringWithShadow(s.substring(j), (float) j1, (float) i1, i);
                }
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    if (fontRendererInstance != null) {
                        ...
                        Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + fontUtil.MAX_HEIGHT, -3092272);
                    }
                }
                else
                {
                    if (fontRendererInstance != null) {
                        ...
                        fontUtil.drawStringWithShadow("_", (float)k1, (float)i1, i);
                    }
                }
            }
            ...
            if (k != j)
            {
                ...
                int l1 = 0;
                if (fontRendererInstance != null) {
                    l1 = l + fontRendererInstance.getStringWidth(s.substring(0, k));
                } else if (fontUtil != null) {
                    l1 = (int) (l + fontUtil.getWidth(s.substring(0, k)));
                }
                int maxHeight = 0;
                if (fontRendererInstance != null) {
                    maxHeight = fontRendererInstance.FONT_HEIGHT;
                } else if (fontUtil != null) {
                    maxHeight = (int) fontUtil.MAX_HEIGHT;
                }
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + maxHeight);
            }
        }
    }
    ...
    public void setSelectionPos(int p_146199_1_)
    {
        ...
        if (this.fontRendererInstance != null)
        {
            ...
            int j = this.getWidth();
            String s = this.fontUtil.trimStringToWidth(this.text.substring(this.lineScrollOffset), j);
            int k = s.length() + this.lineScrollOffset;

            if (p_146199_1_ == this.lineScrollOffset)
            {
                this.lineScrollOffset -= this.fontUtil.trimStringToWidth(this.text, j, true).length();
            }
