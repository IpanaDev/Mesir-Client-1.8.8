...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.theFlatGeneratorInfo.getFlatLayers().clear();
        this.func_146375_g();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.flatWorldTitle, this.width / 2, 8, 16777215);
        int i = this.width / 2 - 92 - 16;
        this.drawString(this.field_146394_i, i, 32, 16777215);
        this.drawString(this.field_146391_r, i + 2 + 213 - this.fontRendererObj.getStringWidth(this.field_146391_r), 32, 16777215);
