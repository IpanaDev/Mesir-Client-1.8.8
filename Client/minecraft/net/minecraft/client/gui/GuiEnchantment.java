    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0) {
                ...
                int ench = this.container.field_178151_h[j];
                if (Enchantment.getEnchantmentById(ench & 255) != null) {
                    String s = Enchantment.getEnchantmentById(ench & 255).getTranslatedName((ench & 65280) >> 8);
                    list.add(EnumChatFormatting.WHITE.toString() + EnumChatFormatting.ITALIC.toString() + s);
                }
