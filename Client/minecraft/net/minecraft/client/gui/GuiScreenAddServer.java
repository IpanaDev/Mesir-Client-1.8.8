...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(I18n.format("addServer.title"), this.width / 2, 17, 16777215);
        this.drawString(I18n.format("addServer.enterName"), this.width / 2 - 100, 53, 10526880);
        this.drawString(I18n.format("addServer.enterIp"), this.width / 2 - 100, 94, 10526880);
