...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(I18n.format("selectServer.direct"), this.width / 2, 20, 16777215);
        this.drawString(I18n.format("addServer.enterIp"), this.width / 2 - 100, 100, 10526880);
