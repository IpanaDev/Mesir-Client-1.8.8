...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(I18n.format("selectWorld.create"), this.width / 2, 20, -1);

        if (this.field_146344_y)
        {
            this.drawString(I18n.format("selectWorld.enterSeed"), this.width / 2 - 100, 47, -6250336);
            this.drawString(I18n.format("selectWorld.seedInfo"), this.width / 2 - 100, 85, -6250336);

            if (this.btnMapFeatures.visible)
            {
                this.drawString(I18n.format("selectWorld.mapFeatures.info"), this.width / 2 - 150, 122, -6250336);
            }

            if (this.btnAllowCommands.visible)
            {
                this.drawString(I18n.format("selectWorld.allowCommands.info"), this.width / 2 - 150, 172, -6250336);
            }
        ...
        {
            this.drawString(I18n.format("selectWorld.enterName"), this.width / 2 - 100, 47, -6250336);
            this.drawString(I18n.format("selectWorld.resultFolder") + " " + this.field_146336_i, this.width / 2 - 100, 85, -6250336);
            this.field_146333_g.drawTextBox();
            this.drawString(this.field_146323_G, this.width / 2 - 100, 137, -6250336);
            this.drawString(this.field_146328_H, this.width / 2 - 100, 149, -6250336);
        }
