...
public class GuiShareToLan extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(I18n.format("lanServer.title"), this.width / 2, 50, 16777215);
        this.drawCenteredString(I18n.format("lanServer.otherPlayers"), this.width / 2, 82, 16777215);
