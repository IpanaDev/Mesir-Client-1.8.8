...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontHelper.SIZE_18.drawCenteredString(this.screenTitle, this.width / 2, 15, 16777215);
        ...
        FontHelper.SIZE_18.drawString( s, 2, this.height - 10, 8421504);
        String s2 = "Minecraft 1.8.8";
        int i = (int) FontHelper.SIZE_18.getWidth(s2);
        FontHelper.SIZE_18.drawString( s2, this.width - i - 2, this.height - 10, 8421504);
