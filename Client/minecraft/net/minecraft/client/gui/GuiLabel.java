    ...
    public void drawLabel(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            for (int k = 0; k < this.field_146173_k.size(); ++k)
            {
                if (this.centered)
                {
                    this.drawCenteredString((String)this.field_146173_k.get(k), this.field_146162_g + this.field_146167_a / 2, j + k * 10, this.field_146168_n);
                }
                else
                {
                    this.drawString((String)this.field_146173_k.get(k), this.field_146162_g, j + k * 10, this.field_146168_n);
                }
            }
        }
    }
