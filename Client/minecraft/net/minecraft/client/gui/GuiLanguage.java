...
public class GuiLanguage extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontHelper.SIZE_18.drawCenteredString(I18n.format("options.language"), this.width / 2, 16, 16777215);
        FontHelper.SIZE_18.drawCenteredString("(" + I18n.format("options.languageWarning") + ")", this.width / 2, this.height - 56, 8421504);
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiLanguage.this.drawCenteredString(((Language)this.languageMap.get(this.langCodeList.get(entryID))).toString(), this.width / 2, p_180791_3_ + 1, 16777215);
