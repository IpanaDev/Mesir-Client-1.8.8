...
public class GuiScreenResourcePacks extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontHelper.SIZE_18.drawCenteredString( I18n.format("resourcePack.title"), this.width / 2, 16, 16777215);
        FontHelper.SIZE_18.drawCenteredString( I18n.format("resourcePack.folderInfo"), this.width / 2 - 77, this.height - 26, 8421504);
