...
public class SoundManager
{
    ...
    public void setListener(EntityPlayer player, float p_148615_2_)
    {
        if (this.loaded && player != null)
        {
            ...
            float n = 0.017453292F;
            float n0 = (f1 + 90f)*n;
            float n1 = -f * n;
            float n2 = (-f + 90f)*n;
            float f2 = MathHelper.cos(n0);
            float f3 = MathHelper.sin(n0);
            float f4 = MathHelper.cos(n1);
            float f5 = MathHelper.sin(n1);
            float f6 = MathHelper.cos(n2);
            float f7 = MathHelper.sin(n2);
            float f8 = f2 * f4;
            float f9 = f3 * f4;
            float f10 = f2 * f6;
            float f11 = f3 * f6;
