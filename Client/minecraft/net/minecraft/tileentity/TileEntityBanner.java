...
public class TileEntityBanner extends TileEntity
{
    ...
    public TileEntityBanner() {
        setRenderer(TileEntityRendererDispatcher.instance.tileEntityBannerRenderer);
    }
                ...
                if (this.patterns != null)
                {
                    for (int i = 0; i < this.patterns.tagCount(); ++i)
                    {
                        ...
                        if (tileentitybanner$enumbannerpattern != null)
                        {
                            ...
                            this.patternResourceLocation = String.format("%s%s%d", this.patternResourceLocation, tileentitybanner$enumbannerpattern.getPatternID(), j);
                        }
                    }
                }
            }
