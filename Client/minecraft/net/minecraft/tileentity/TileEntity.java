...
public abstract class TileEntity
{
    ...
    private TileEntitySpecialRenderer<? extends TileEntity> renderer;
    public int cullingTicks;
    public boolean culled;
    private AxisAlignedBB boundingBox;
    public double distForRender;
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.boundingBox = new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), pos.getX()+1, pos.getY()+1, pos.getZ()+1);
    }
    ...
    public void setRenderer(TileEntitySpecialRenderer<? extends TileEntity> _renderer) {
        renderer = _renderer;
    }

    public TileEntitySpecialRenderer<? extends TileEntity> renderer() {
        return renderer;
    }
    ...
    public boolean canBeSeen(int x, int y, int z) {
        int threshold = 2;
        if (Minecraft.getRunTick()-cullingTicks > threshold) {
            culled = PlayerUtils.rayTraceSimple(boundingBox);
            EntityPlayer entityplayer = Minecraft.getMinecraft().thePlayer;
            distForRender = getDistanceSq(entityplayer.posX, entityplayer.posY, entityplayer.posZ);
            cullingTicks = Minecraft.getRunTick();
        }
        return /*culled*/true;
    }
}
