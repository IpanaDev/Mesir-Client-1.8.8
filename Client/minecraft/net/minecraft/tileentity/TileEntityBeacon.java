...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, IInventory
{
    ...
    public TileEntityBeacon() {
        setRenderer(TileEntityRendererDispatcher.instance.tileEntityBeaconRenderer);
    }
    ...
    {
        switch (id) {
            case 0 -> this.levels = value;
            case 1 -> this.primaryEffect = this.func_183001_h(value);
            case 2 -> this.secondaryEffect = this.func_183001_h(value);
        }
    }
