...
public class PlayerSelector
{
    ...
    private static boolean isEntityTypeValid(ICommandSender commandSender, Map<String, String> params)
    {
        ...
        if (map.size() > 0)
        {
            list.add(p_apply_1_ -> {
                ...
                for (Entry<String, Integer> entry : map.entrySet())
                {
                    ...
                    String s1 = null;
                    if (p_apply_1_ != null) {
                        s1 = p_apply_1_ instanceof EntityPlayerMP ? p_apply_1_.getName() : p_apply_1_.getUniqueID().toString();
                    }
    ...
    private static <T extends Entity> List<T> filterResults(Map<String, String> params, Class<? extends T> entityClass, List<Predicate<Entity>> inputList, String type, World worldIn, BlockPos position) {
        ...
        if (position != null) {
            ...
            if (!params.containsKey("dx") && !params.containsKey("dy") && !params.containsKey("dz")) {
                if (l >= 0) {
                    axisalignedbb1 = new AxisAlignedBB((position.getX() - l), (position.getY() - l), (position.getZ() - l), (position.getX() + l + 1), (position.getY() + l + 1), (position.getZ() + l + 1));
                    if (flag && flag2 && !flag1) {
                ...
                if (flag && flag2 && !flag1) {
                    ...
                    Predicate<Entity> predicate2 = p_apply_1_ -> {
                        assert p_apply_1_ != null;
    ...
    private static <T extends Entity> List<T> func_179658_a(List<T> p_179658_0_, Map<String, String> p_179658_1_, ICommandSender p_179658_2_, Class <? extends T > p_179658_3_, String p_179658_4_, final BlockPos p_179658_5_)
    {
        ...
        T entity = (T) p_179658_2_.getCommandSenderEntity();
        ...
        if (entity != null && p_179658_3_.isAssignableFrom(entity.getClass()) && i == 1 && p_179658_0_.contains(entity) && !"r".equals(p_179658_4_))
        {
            ...
            Collections.addAll(list, entity);
            p_179658_0_ = list;
        }
    ...
    static int computeArrayListCapacity() {
        return Ints.saturatedCast(5L + (long) 1);
    }
