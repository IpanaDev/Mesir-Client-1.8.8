...
import static net.minecraft.world.biome.Biomes.field_180279_ad;
...
public abstract class WorldProvider
{
    ...
    protected void registerWorldChunkManager()
    {
        ...
        if (worldtype == WorldType.FLAT)
        {
            ...
            this.worldChunkMgr = new WorldChunkManagerHell(BiomeGenBase.getBiomeFromBiomeList(flatgeneratorinfo.getBiome(), field_180279_ad), 0.5F);
        }
        else if (worldtype == WorldType.DEBUG_WORLD)
        {
            this.worldChunkMgr = new WorldChunkManagerHell(plains, 0.0F);
        }
        else
        {
