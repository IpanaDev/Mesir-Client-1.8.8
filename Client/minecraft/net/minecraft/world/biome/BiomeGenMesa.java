...
import static net.minecraft.world.biome.Biomes.height_LowHills;
import static net.minecraft.world.biome.Biomes.mesa;
...
public class BiomeGenMesa extends BiomeGenBase
{
    ...
    {
        boolean flag = this.biomeID == mesa.biomeID;
