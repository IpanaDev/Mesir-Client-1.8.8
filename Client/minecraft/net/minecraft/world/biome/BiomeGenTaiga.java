...
import static net.minecraft.world.biome.Biomes.DOUBLE_PLANT_GENERATOR;
import static net.minecraft.world.biome.Biomes.megaTaiga;
...
public class BiomeGenTaiga extends BiomeGenBase
{
    ...
    {
        return this.biomeID == megaTaiga.biomeID ? (new BiomeGenTaiga(p_180277_1_, 2)).func_150557_a(5858897, true).setBiomeName("Mega Spruce Taiga").setFillerBlockMetadata(5159473).setTemperatureRainfall(0.25F, 0.8F).setHeight(new BiomeGenBase.Height(this.minHeight, this.maxHeight)) : super.createMutatedBiome(p_180277_1_);
    }
}
