...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public boolean convertMapFormat(String filename, IProgressUpdate progressCallback)
    {
        ...
        {
            worldchunkmanager = new WorldChunkManagerHell(plains, 0.5F);
        }
        else
        {
        ...
        this.convertFile(new File(file2, "region"), list1, new WorldChunkManagerHell(hell, 0.0F), list.size(), i, progressCallback);
        this.convertFile(new File(file3, "region"), list2, new WorldChunkManagerHell(sky, 0.0F), list.size() + list1.size(), i, progressCallback);
