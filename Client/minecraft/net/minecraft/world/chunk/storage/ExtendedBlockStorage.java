...
public class ExtendedBlockStorage
{
    ...
    public IBlockState get(int x, int y, int z) {
        IBlockState iblockstate = Block.BLOCK_STATE_IDS.getByValue(this.dataArray[y << 8 | z << 4 | x]);
    ...
    public void set(int x, int y, int z, IBlockState state) {
        ...
        this.dataArray[y << 8 | z << 4 | x] = (char) Block.BLOCK_STATE_IDS.get(state);
    }
        ...
        for (int k = 0; k < 16; ++k) {
            for (int l = 0; l < 16; ++l) {
                for (int i1 = 0; i1 < 16; ++i1) {
                    IBlockState iblockstate1 = get(i1, k, l);
