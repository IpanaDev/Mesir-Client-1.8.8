...
public class StructureOceanMonument extends MapGenStructure
{
    ...
    public static final List<BiomeGenBase> field_175802_d = Arrays.asList(ocean, deepOcean, river, frozenOcean, frozenRiver);
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ)
    {
        ...
        if (i == k && j == l)
        {
            if (this.worldObj.getWorldChunkManager().getBiomeGenerator(new BlockPos(i * 16 + 8, 64, j * 16 + 8), (BiomeGenBase)null) != deepOcean)
            {
                return false;
            }
