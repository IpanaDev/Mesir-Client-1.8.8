...
{
    private static final List<BiomeGenBase> biomelist = Arrays.<BiomeGenBase>asList(desert, desertHills, jungle, jungleHills, swampland);
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World worldIn, Random p_i2060_2_, int p_i2060_3_, int p_i2060_4_)
        {
            ...
            if (biomegenbase != jungle && biomegenbase != jungleHills)
            {
                ...
                else if (biomegenbase == desert || biomegenbase == desertHills)
                {
