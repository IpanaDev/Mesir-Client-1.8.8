    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (!this.replaceBiomeEdgeIfNecessary(aint, aint1, j, i, areaWidth, k, extremeHills.biomeID, extremeHillsEdge.biomeID) && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, mesaPlateau_F.biomeID, mesa.biomeID) && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, mesaPlateau.biomeID, mesa.biomeID) && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, megaTaiga.biomeID, taiga.biomeID))
                {
                    if (k == desert.biomeID)
                    {
                        ...
                        if (l1 != icePlains.biomeID && i2 != icePlains.biomeID && j2 != icePlains.biomeID && k2 != icePlains.biomeID)
                        {
                            aint1[j + i * areaWidth] = k;
                        }
                        else
                        {
                            aint1[j + i * areaWidth] = extremeHillsPlus.biomeID;
                        }
                    }
                    else if (k == swampland.biomeID)
                    {
                        ...
                        if (l != desert.biomeID && i1 != desert.biomeID && j1 != desert.biomeID && k1 != desert.biomeID && l != coldTaiga.biomeID && i1 != coldTaiga.biomeID && j1 != coldTaiga.biomeID && k1 != coldTaiga.biomeID && l != icePlains.biomeID && i1 != icePlains.biomeID && j1 != icePlains.biomeID && k1 != icePlains.biomeID)
                        {
                            if (l != jungle.biomeID && k1 != jungle.biomeID && i1 != jungle.biomeID && j1 != jungle.biomeID)
                            {
                                aint1[j + i * areaWidth] = k;
                            }
                            else
                        ...
                        {
                            aint1[j + i * areaWidth] = plains.biomeID;
                        }
                    }
                    else
                    {
