...
public abstract class GenLayer
{
    ...
    protected static boolean biomesEqualOrMesaPlateau(int biomeIDA, int biomeIDB)
    {
        ...
        else if (biomeIDA != mesaPlateau_F.biomeID && biomeIDA != mesaPlateau.biomeID)
        {
        ...
        {
            return biomeIDB == mesaPlateau_F.biomeID || biomeIDB == mesaPlateau.biomeID;
        }
    }
    ...
    {
        return p_151618_0_ == ocean.biomeID || p_151618_0_ == deepOcean.biomeID || p_151618_0_ == frozenOcean.biomeID;
    }
