...
public class GenLayerShore extends GenLayer
{
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k == mushroomIsland.biomeID)
                {
                    ...
                    if (j2 != ocean.biomeID && i3 != ocean.biomeID && l3 != ocean.biomeID && k4 != ocean.biomeID)
                    {
                        aint1[j + i * areaWidth] = k;
                    }
                    else
                    {
                        aint1[j + i * areaWidth] = mushroomIslandShore.biomeID;
                    }
                }
                else if (biomegenbase != null && biomegenbase.getBiomeClass() == BiomeGenJungle.class)
                {
                    ...
                    if (this.func_151631_c(i2) && this.func_151631_c(l2) && this.func_151631_c(k3) && this.func_151631_c(j4))
                    {
                        ...
                        {
                            aint1[j + i * areaWidth] = beach.biomeID;
                        }
                    }
                    else
                    {
                        aint1[j + i * areaWidth] = jungleEdge.biomeID;
                    }
                }
                else if (k != extremeHills.biomeID && k != extremeHillsPlus.biomeID && k != extremeHillsEdge.biomeID)
                {
                    if (biomegenbase != null && biomegenbase.isSnowyBiome())
                    {
                        this.func_151632_a(aint, aint1, j, i, areaWidth, k, coldBeach.biomeID);
                    }
                    else if (k != mesa.biomeID && k != mesaPlateau_F.biomeID)
                    {
                        if (k != ocean.biomeID && k != deepOcean.biomeID && k != river.biomeID && k != swampland.biomeID)
                        {
                    ...
                    else
                    {
                        ...
                        if (!isBiomeOceanic(l) && !isBiomeOceanic(i1) && !isBiomeOceanic(j1) && !isBiomeOceanic(k1))
                        {
                            ...
                            {
                                aint1[j + i * areaWidth] = desert.biomeID;
                            }
                        }
                        else
                        {
                ...
                {
                    this.func_151632_a(aint, aint1, j, i, areaWidth, k, stoneBeach.biomeID);
                }
            }
        }
    ...
    {
        return getBiome(p_151631_1_) != null && getBiome(p_151631_1_).getBiomeClass() == BiomeGenJungle.class ? true : p_151631_1_ == jungleEdge.biomeID || p_151631_1_ == jungle.biomeID || p_151631_1_ == jungleHills.biomeID || p_151631_1_ == forest.biomeID || p_151631_1_ == taiga.biomeID || isBiomeOceanic(p_151631_1_);
    }

    private boolean func_151633_d(int p_151633_1_)
    {
        return getBiome(p_151633_1_) instanceof BiomeGenMesa;
    }
}
