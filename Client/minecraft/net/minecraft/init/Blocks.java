...
public class Blocks
{
    ...
    public static final BlockItemFrame itemFrame;
    ...
    {
        Block b = Block.blockRegistry.getObject(new ResourceLocation(p_180383_0_));
        blockList.add(b);
        return b;
    }
    ...
    static
    {
        ...
        else
        {
            ...
            itemFrame = (BlockItemFrame) getRegisteredBlock("item_frame");
        }
    }
}
