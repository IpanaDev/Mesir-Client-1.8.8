...
public abstract class BlockSlab extends Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos normalPos, BlockPos pos, EnumFacing side)
    {
        ...
        if (this.isDouble())
        {
            return super.shouldSideBeRendered(worldIn, normalPos, pos, side);
        }
        else if (side != EnumFacing.UP && side != EnumFacing.DOWN && !super.shouldSideBeRendered(worldIn, normalPos, pos, side))
        {
            return false;
        }
        else
        {
            ...
            return flag1 ? (side == EnumFacing.DOWN || (side == EnumFacing.UP && super.shouldSideBeRendered(worldIn, normalPos, pos, side) || !isSlab(iblockstate.getBlock()) || !flag)) : (side == EnumFacing.UP || (side == EnumFacing.DOWN && super.shouldSideBeRendered(worldIn, normalPos, pos, side) || !isSlab(iblockstate.getBlock()) || flag));
        }
    }
