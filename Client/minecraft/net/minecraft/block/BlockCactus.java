...
public class BlockCactus extends Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos normalPos, BlockPos pos, EnumFacing side) {
        boolean hee = worldIn.getBlockState(normalPos.add(0,1,0)).getBlock() instanceof BlockCactus && side == EnumFacing.UP;

        return !hee && super.shouldSideBeRendered(worldIn, normalPos, pos, side);
    }
