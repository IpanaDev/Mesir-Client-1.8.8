...
public class EntityList
{
    ...
    public static final Map < Class <? extends Entity > , Integer > classToIDMapping = Maps.newHashMap();
    public static final Map<String, Integer> stringToIDMapping = Maps.newHashMap();
    ...
    private static void addMapping(Class <? extends Entity > entityClass, String entityName, int id)
    {
        ...
        else
        {
            ...
            REGISTRY.register(id, resourcelocation, entityClass);
