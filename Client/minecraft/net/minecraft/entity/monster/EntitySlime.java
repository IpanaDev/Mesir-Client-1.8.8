...
import static net.minecraft.world.biome.Biomes.swampland;
...
public class EntitySlime extends EntityLiving implements IMob
{
    ...
    public EntitySlime(World worldIn)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderSlime);
    }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        else
        {
            if (this.worldObj.getDifficulty() != EnumDifficulty.PEACEFUL)
            {
                ...
                if (biomegenbase == swampland && this.posY > 50.0D && this.posY < 70.0D && this.rand.nextFloat() < 0.5F && this.rand.nextFloat() < this.worldObj.getCurrentMoonPhaseFactor() && this.worldObj.getLightFromNeighbors(new BlockPos(this)) <= this.rand.nextInt(8))
                {
