...
public class EntityWitch extends EntityMob implements IRangedAttackMob
{
    ...
    public EntityWitch(World worldIn)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderWitch);
    }
    ...
    public void onLivingUpdate()
    {
        if (!this.worldObj.isRemote)
        {
            ...
            else
            {
                ...
                if (this.rand.nextFloat() < 0.15F && this.isInsideOfWater && !this.isPotionActive(Potion.waterBreathing))
                {
                    i = 8237;
                }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_)
    {
        if (!this.getAggressive())
        {
            ...
            float f = (float) MathHelper.sqrt_double(d1 * d1 + d3 * d3);
