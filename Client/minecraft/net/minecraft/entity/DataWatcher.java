...
public class DataWatcher
{
     ...
     */
    public static void writeWatchedListToPacketBuffer(List<DataWatcher.WatchableObject> objectsList, PacketBuffer buffer) {
        if (objectsList != null)
        {
    ...
    private static void writeWatchableObjectToPacketBuffer(PacketBuffer buffer, DataWatcher.WatchableObject object) {
        ...
        switch (object.getObjectType()) {
            case 0 -> buffer.writeByte((Byte) object.getObject());
            case 1 -> buffer.writeShort((Short) object.getObject());
    ...
    public void updateWatchedObjectsFromList(List<DataWatcher.WatchableObject> p_75687_1_)
    {
        ...
        {
            DataWatcher.WatchableObject idObject = this.watchedObjects.get(watchableObject.getDataValueId());

            if (idObject != null)
            {
                this.owner.onWatcherUpdateObjects(watchableObject.getDataValueId(), idObject.getObject(), watchableObject.getObject());
                idObject.setObject(watchableObject.getObject());
