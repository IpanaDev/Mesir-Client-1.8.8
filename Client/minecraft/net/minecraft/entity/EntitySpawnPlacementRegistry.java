...
{
    private static final HashMap<Class<? extends EntityLiving >, EntityLiving.SpawnPlacementType> ENTITY_PLACEMENTS = Maps.newHashMap();

    public static EntityLiving.SpawnPlacementType getPlacementForEntity(Class<? extends EntityLiving > entityClass)
    {
