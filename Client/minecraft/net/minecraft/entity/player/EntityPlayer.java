...
import net.minecraft.client.renderer.entity.layers.bok.StickSimulation;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public GLists<String> nameTagsList;
    public StickSimulation stickSimulation = new StickSimulation();
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn) {
        ...
        this.isDinnerbone = isUpsideDown(gameProfile.getName());
    ...
    public void onUpdate() {
        ...
        if (this.itemInUse != null) {
            ...
            if (itemstack == this.itemInUse) {
                ...
                EventClearItemUse event = new EventClearItemUse();
                event.fire();
                if (event.isCancelled() && itemstack != null && itemstack.item == this.itemInUse.item) {
                    ...
                    if (Minecraft.getMinecraft().gameSettings.keyBindUseItem.pressed && Modules.NO_SLOW_DOWN.isEnabled() && PlayerUtils.isMoving2() && (itemstack == null || !(itemstack.item instanceof ItemSword)) && itemInUse.item instanceof ItemSword) {
        ...
        activeEmotes().removeIf(action -> {
            action.prevTicks = action.leftTicks;
            action.leftTicks--;
            return action.leftTicks <= 0;
        });
    ...
    public void onLivingUpdate() {
        ...
        double f = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
    ...
    public EntityItem dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem) {
        if (droppedItem == null) {
            ...
            if (dropAround) {
                ...
                entityitem.motionX += MathHelper.cos((double) f3) * (double) f2;
                entityitem.motionY += (double) ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.1F);
                entityitem.motionZ += MathHelper.sin((double) f3) * (double) f2;
            }
    ...
    public void addMovementStat(double p_71000_1_, double p_71000_3_, double p_71000_5_) {
        if (this.ridingEntity == null) {
            if (this.isInsideOfMaterial(Material.water)) {
                int i = Math.round((float)MathHelper.sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_3_ * p_71000_3_ + p_71000_5_ * p_71000_5_) * 100.0F);
                ...
                int j = Math.round((float)MathHelper.sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
                ...
                int k = Math.round((float)MathHelper.sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
                ...
                int l = Math.round((float)MathHelper.sqrt_double(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
    ...
    private void addMountedMovementStat(double p_71015_1_, double p_71015_3_, double p_71015_5_) {
        if (this.ridingEntity != null) {
            int i = Math.round((float)MathHelper.sqrt_double(p_71015_1_ * p_71015_1_ + p_71015_3_ * p_71015_3_ + p_71015_5_ * p_71015_5_) * 100.0F);
    ...
    public void setItemInUse(ItemStack stack, int duration) {
        if (stack != this.itemInUse) {
            ...
            if (this == Minecraft.getMinecraft().thePlayer && stack != null && (stack.getItemUseAction() == EnumAction.DRINK || stack.getItemUseAction() == EnumAction.EAT)) {
                if (!drink.isEnabled() || !drink.swap || inventory.currentItem != 0) {
    ...
    /**
     * Copies the values from the given player into this player if boolean par2 is true. Always clones NCP313 Chest
     * Inventory.
     */
    ...
    private List<EmoteUtils.Action> activeEmotes = new ArrayList<>();

    public List<EmoteUtils.Action> activeEmotes() {
        return activeEmotes;
    }

    public void updateSimulation(EntityPlayer abstractClientPlayer, int partCount) {
        var simulation = stickSimulation;
        var dirty = false;
        ...
        if (dirty) {
            for (var i = 0; i < 10; i++) { // quickly doing a few simulation steps to get the cape int a stable configuration
    ...
    public void simulate(EntityPlayer abstractClientPlayer) {
        var simulation = stickSimulation;
        if (simulation.points.isEmpty()) return; // no cape, nothing to update
        simulation.points.get(0).prevPosition.copy(simulation.points.get(0).position);
        var d = abstractClientPlayer.chasingPosX - abstractClientPlayer.posX;
        var m = abstractClientPlayer.chasingPosZ - abstractClientPlayer.posZ;
        d*=2;
        m*=2;
        ...
        var fallHack = MathHelper.clamp_double(simulation.points.get(0).position.y - abstractClientPlayer.posY * heightMul, 0d, 1d);
