...
import static net.minecraft.world.biome.Biomes.explorationBiomesList;
...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    protected void updateBiomesExplored()
    {
        ...
        if (this.getStatFile().canUnlockAchievement(AchievementList.exploreAllBiomes) && jsonserializableset.size() >= explorationBiomesList.size())
        {
            Set<BiomeGenBase> set = Sets.newHashSet(explorationBiomesList);
