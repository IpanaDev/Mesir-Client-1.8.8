...
public class EntityFishHook extends Entity
{
    ...
    public EntityFishHook(World worldIn)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderFish);
    }
    ...
    {
        double f = MathHelper.sqrt_double(p_146035_1_ * p_146035_1_ + p_146035_3_ * p_146035_3_ + p_146035_5_ * p_146035_5_);
        ...
        double f1 = MathHelper.sqrt_double(p_146035_1_ * p_146035_1_ + p_146035_5_ * p_146035_5_);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (!this.inGround)
            {
                ...
                double f5 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
