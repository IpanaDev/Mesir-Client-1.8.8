...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public EntityArrow(World worldIn, double x, double y, double z)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderArrow);
    }
    ...
    public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy)
    {
        ...
        this.motionY = y;
        this.motionZ = z;
        double f1 = MathHelper.sqrt_double(x * x + z * z);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)l))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            {
                                double f7 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
                ...
                else
                {
                    ...
                    double f5 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
        ...
        if (this.worldObj.isRemote) {
            double hypot = Math.hypot(this.posX - this.prevPosX, this.posZ - this.prevPosZ);
            if (hypot == 0) {
                return;
            }
            //PlayerUtils.debug(hypot);
        }
    }
