...
public class EntityEnderEye extends Entity
{
    ...
    public EntityEnderEye(World worldIn, double x, double y, double z)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderEnderEye);
    }
    ...
    public void moveTowards(BlockPos p_180465_1_)
    {
        ...
        float f = (float) MathHelper.sqrt_double(d2 * d2 + d3 * d3);
    ...
    public void setVelocity(double x, double y, double z)
    {
        ...
        {
            float f = (float) MathHelper.sqrt_double(x * x + z * z);
    ...
    public void onUpdate()
    {
        ...
        float f = (float) MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
