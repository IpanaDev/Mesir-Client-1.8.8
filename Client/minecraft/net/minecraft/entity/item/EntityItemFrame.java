...
public class EntityItemFrame extends EntityHanging {
    ...
    public EntityItemFrame(World worldIn) {
        super(worldIn);
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderItemFrame);
    }
    ...
    {
        return ticksExisted == 0 ? new ItemStack() : this.getDataWatcher().getWatchableObjectItemStack(8);
    }
    ...
    public void updateChunk() {
        if (Minecraft.getMinecraft().renderGlobal != null) {
            Minecraft.getMinecraft().renderGlobal.markBlockForUpdate(this.getHangingPosition());
        }
    }
