...
public class EntityBoat extends Entity
{
    ...
    public EntityBoat(World worldIn)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderBoat);
    }
    ...
    public void onUpdate() {
        super.onUpdate();
        boolean vehicleFly = Modules.FLY.isEnabled() && Modules.FLY.mode.getValue() instanceof Vehicle && Minecraft.getMinecraft().thePlayer.ridingEntity == this;
        ...
        if (this.worldObj.isRemote && this.isBoatEmpty) {
            ...
            if (!this.worldObj.isRemote && !vehicleFly) {
