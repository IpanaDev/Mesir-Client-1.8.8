...
public class EntityItem extends Entity
{
    ...
    private ItemStack watchedItemStack, lastWatchedItemStack;
    ...
    public EntityItem(World worldIn, double x, double y, double z)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderEntityItem);
    }
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (this.motionX > -1E-4 && this.motionX < 1E-4) {
                this.motionX = 0;
            } else {
                this.motionX *= f;
            }
            this.motionY *= 0.9800000190734863D;
            if (this.motionZ > -1E-4 && this.motionZ < 1E-4) {
                this.motionZ = 0;
            } else {
                this.motionZ *= f;
            }
    ...
    public ItemStack getEntityItem() {
        if (watchedItemStack != lastWatchedItemStack || watchedItemStack == null || bakedModel == null) {
            ItemStack newStack = this.getDataWatcher().getWatchableObjectItemStack(10);
            entityItem = newStack;
            watchedItemStack = newStack;
            lastWatchedItemStack = newStack;
            if (entityItem == null) {
                if (this.worldObj != null) {
                    logger.error("Item entity " + this.getEntityId() + " has no item?!");
                }
                entityItem = new ItemStack(Blocks.stone);
            }
            bakedModel = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getItemModel(entityItem);
        }
        return entityItem;
    }
    ...
    public void setBakedModel(IBakedModel _bakedModel) {
        bakedModel = _bakedModel;
    }
