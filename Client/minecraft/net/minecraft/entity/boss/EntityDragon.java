...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public EntityDragon(World worldIn)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderDragon);
    }
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            float f10 = (float) (0.2F / (MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ) * 10.0F + 1.0F));
            ...
            else
            {
                ...
                else
                {
                    ...
                    float f6 = (float) (MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ) * 1.0F + 1.0F);
