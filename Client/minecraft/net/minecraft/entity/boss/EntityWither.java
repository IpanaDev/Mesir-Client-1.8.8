...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    public EntityWither(World worldIn)
    {
        ...
        setRenderObject(Minecraft.getMinecraft().getRenderManager().renderWither);
    }
        ...
        else
        {
            ...
            for (int i = 1; i < 3; ++i)
            {
                if (this.ticksExisted >= this.field_82223_h[i - 1])
                {
                    ...
                    {
                        List<EntityLivingBase> list = this.worldObj.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(20.0D, 8.0D, 20.0D), and(attackEntitySelector, EntitySelectors.NOT_SPECTATING));
