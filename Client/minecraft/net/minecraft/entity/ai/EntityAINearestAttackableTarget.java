...
public class EntityAINearestAttackableTarget<T extends EntityLivingBase> extends EntityAITarget
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            List<T> list = this.taskOwner.worldObj.getEntitiesWithinAABB(this.targetClass, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0D, d0), and(this.targetEntitySelector, (Predicate<? super T>) EntitySelectors.NOT_SPECTATING));
