...
public final class ItemStack
{
    ...
    {
        this.canDestroyCacheBlock = stack.canDestroyCacheBlock;
        this.canDestroyCacheResult = stack.canDestroyCacheResult;
        this.canPlaceOnCacheBlock = stack.canPlaceOnCacheBlock;
        this.canPlaceOnCacheResult = stack.canPlaceOnCacheResult;
        this.item = stack.getItem();
        this.stackSize = stack.stackSize;
        this.itemDamage = stack.itemDamage;
        this.itemFrame = stack.itemFrame;
        this.stackTagCompound = stack.stackTagCompound;
        this.animationsToGo = stack.animationsToGo;
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt)
    {
        ...
        nbt.setShort("DuraTest", (short)this.itemDamage);
    ...
    public void readFromNBT(NBTTagCompound nbt)
    {
        ...
        this.itemDamage = nbt.getShort("DuraTest");
    ...
    public static boolean areItemStacksEqual2(ItemStack stackA, ItemStack stackB) {
        return stackA == null && stackB == null || (stackA != null && stackB != null && stackA.isItemStackEqual(stackB) && stackA.animationsToGo == stackB.animationsToGo);
    }
    /**
    ...
    public boolean tagCompoundsEqual(ItemStack other) {
        return ((this.stackTagCompound != null || other.stackTagCompound == null) && (this.stackTagCompound == null || this.stackTagCompound.equals(other.stackTagCompound)));
    }
    /**
    ...
    {
        return this.stackSize == other.stackSize && (this.item == other.item && getItemUseAction() == other.getItemUseAction() && (this.itemDamage == other.itemDamage && tagCompoundsEqual(other)));
    }
    ...
    public void setTextureLocation() {
        if (item == null) {
            textureLocation = TextureMap.LOCATION_MISSING_TEXTURE;
        } else {
            if (Minecraft.getMinecraft().getRenderItem() != null) {
                IBakedModel itemModel = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getItemModel(this);
                ResourceLocation location;
                if (itemModel.getParticleTexture() == null) {
                    location = TextureMap.LOCATION_MISSING_TEXTURE;
                } else {
                    String name = itemModel.getParticleTexture().getIconName().replace("minecraft:", "minecraft:textures/")+".png";
