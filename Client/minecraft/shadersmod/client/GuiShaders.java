...
public class GuiShaders extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (i < this.width - 5)
        {
            this.drawCenteredString(s, this.width / 2, this.height - 40, 8421504);
        }
        else
        {
            this.drawString(s, 5, this.height - 40, 8421504);
        }
    ...
    {
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(text, (x - Minecraft.getMinecraft().fontRendererObj.getStringWidth(text) / 2f), (float)y, color);
    }
