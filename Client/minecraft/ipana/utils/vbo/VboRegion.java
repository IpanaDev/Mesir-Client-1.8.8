...
public class VboRegion {
    ...
    public void finishDraw(VboRenderList vboRenderList) {
        ...
        //shaderManager.loadShader("mesh");
        GlStateManager.glMultiDrawArrays(GL11.GL_QUADS, this.bufferIndexVertex, this.bufferCountVertex);
        //shaderManager.stop("mesh");
