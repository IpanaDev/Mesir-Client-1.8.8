...
public class BlockStateInterface {
    ...
    public BlockStateInterface(World world, WorldData worldData, boolean copyLoadedChunks) {
        ...
        LongHashMap worldLoaded = ((ChunkProviderClient) world.getChunkProvider()).loadedChunks();
        if (copyLoadedChunks) {
            this.loadedChunks = new LongHashMap(worldLoaded); // make a copy that we can safely access from another thread
        } else {
