...
public class BlockPlaceHelper implements Helper {
    ...
    public void tick(boolean rightClickRequested) {
        ...
        if (!rightClickRequested || ctx.player().ridingEntity instanceof EntityBoat || mouseOver == null || mouseOver.getBlockPos() == null || mouseOver.typeOfHit != MovingObjectPosition.MovingObjectType.BLOCK) {
            return;
        }
