...
public class CustomColors
{
    ...
    private static final CustomColors.IColorizer COLORIZER_GRASS = new CustomColors.IColorizer()
    {
        public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_)
        {
            ...
            return CustomColors.swampGrassColors != null && biomegenbase == swampland ? CustomColors.swampGrassColors.getColor(biomegenbase, p_getColor_2_) : biomegenbase.getGrassColorAtPos(p_getColor_2_);
        }
    ...
    private static final CustomColors.IColorizer COLORIZER_FOLIAGE = new CustomColors.IColorizer()
    {
        ...
        {
            BiomeGenBase biomegenbase = CustomColors.getColorBiome(p_getColor_1_, p_getColor_2_);
            return CustomColors.swampFoliageColors != null && biomegenbase == swampland ? CustomColors.swampFoliageColors.getColor(biomegenbase, p_getColor_2_) : biomegenbase.getFoliageColorAtPos(p_getColor_2_);
        }
        public boolean isColorConstant()
        {
            return false;
    ...
    protected static BiomeGenBase getColorBiome(IBlockAccess p_getColorBiome_0_, BlockPos p_getColorBiome_1_)
    {
        ...
        if (biomegenbase == swampland && !Config.isSwampColors())
        {
            biomegenbase = plains;
        }
